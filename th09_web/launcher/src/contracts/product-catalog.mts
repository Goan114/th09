...
export const PRODUCT_GAMES = Object.freeze({
  ...
  th09: Object.freeze({
    number: "09", title: "東方花映塚", subtitle: "Phantasmagoria of Flower View",
    storage: Object.freeze({saveRoot:"/savesth09",scoreFile:"score.dat",configFiles:Object.freeze(["th09.cfg"])}),
    runtime:"./runtime/th09/th09.html",dataProvider:"emscripten-preload",
    package:Object.freeze({dataFileId:"game-data",dataTarget:"/th09.data",musicSourceDirectories:Object.freeze({wav:"music"}),musicMounts:Object.freeze({wav:"/music"})}),
